...
const fallbackDictionary = {
  ...
  "Đang hoạt động": "Active",
  "Chờ ký nhận": "Awaiting Signature",
  "Bản nháp": "Draft",
  "Đã hủy": "Cancelled",
  "Bình thường": "Normal",
  "Thiếu": "Missing",
  ...
  "Đã thanh lý": "Disposed",
  "Từ chối": "Rejected",
  "Lãnh đạo và quản lý chiến lược phát triển doanh nghiệp.": "Leadership and strategic business management.",
  "Phát triển, vận hành và hỗ trợ hệ thống công nghệ.": "Develop, operate and support technology systems.",
  "Phụ trách khách hàng, hợp đồng và hoạt động bán hàng.": "Responsible for customers, contracts and sales operations.",
  "Quản lý cơ sở vật chất và hoạt động nội bộ.": "Manage facilities and internal operations.",
  "Quản lý ngân sách, thanh toán và báo cáo tài chính.": "Manage budgets, payments and financial reporting.",
  "Tuyển dụng, đào tạo, quản lý nhân sự và chế độ phúc lợi.": "Recruitment, training, HR management and benefits.",
  "Quản lý thương hiệu, chạy chiến dịch và truyền thông.": "Manage branding, campaigns and communications.",
  "Laptop chính cấp cho nhân viên kỹ thuật.": "Primary laptop issued to engineering staff.",
  "Thiết bị dự phòng sẵn sàng bàn giao.": "Spare device ready for assignment.",
  "Laptop cấu hình cao dành cho thiết kế/quản lý.": "High-spec laptop for design/management work.",
  "Laptop văn phòng dòng doanh nghiệp siêu bền.": "Durable business-grade office laptop.",
  "Màn hình làm việc 24 inch.": "24-inch work monitor.",
  "Màn hình đồ họa độ phân giải cao.": "High-resolution graphics monitor.",
  "Màn hình UltraSharp cao cấp chống mỏi mắt.": "Premium UltraSharp monitor with eye comfort.",
  "Máy in dùng chung khu vực hành chính.": "Shared printer for the administration area.",
  "Máy in/scan đa năng đặt tại phòng Admin Tầng 1.": "Multi-function printer/scanner located in the Admin room on Floor 1.",
  "Máy chiếu phòng họp lớn.": "Projector for the large meeting room.",
  "Màn hình TV trình chiếu hội nghị phòng họp A.": "Conference display TV for Meeting Room A.",
  "Thiết bị đang chờ đánh giá sửa chữa.": "Device waiting for repair assessment.",
  "Chuột không dây công thái học dự phòng.": "Spare ergonomic wireless mouse.",
  "Đang trong quy trình xác minh thất lạc.": "Currently under lost-asset verification.",
  "Điện thoại công tác cấp cho quản lý kinh doanh.": "Work phone issued to sales management.",
  "Thiết bị đã thanh lý.": "Disposed device.",
  "Switch mạng trung tâm tầng 2 trong tủ Rack.": "Core network switch on Floor 2 in the rack cabinet.",
  "Thiết bị tường lửa cổng mạng chính của công ty.": "Firewall device for the company's main network gateway.",
  "Thiết bị phát Wifi 6 gắn trần Tầng 2.": "Ceiling-mounted Wi-Fi 6 access point on Floor 2.",
  "Máy chủ Server chạy hệ thống ảo hóa dữ liệu nội bộ.": "Server running the internal data virtualization system.",
  "Ổ đĩa mạng trung tâm lưu trữ và sao lưu dữ liệu.": "Central network storage for data storage and backup.",
  "Bộ lưu điện dự phòng cấp nguồn tủ Rack khi mất điện.": "UPS backup power for the rack cabinet during outages.",
  "Máy hủy tài liệu giấy hành chính tại quầy in.": "Paper shredder for administration at the print counter.",
  "Máy quét tài liệu scan trực tiếp lưu cloud.": "Document scanner with direct cloud scan storage.",
  "Loa và mic Bluetooth di động phục vụ họp trực tuyến.": "Portable Bluetooth speaker and microphone for online meetings.",
  "Bàn giao laptop và bộ sạc phục vụ công việc lập trình.": "Assigned laptop and charger for programming work.",
  "Bàn giao màn hình làm việc tại vị trí.": "Assigned work monitor at the desk.",
  "Đã thu hồi sau khi hoàn thành dự án kiểm toán tài chính năm.": "Returned after completing the annual financial audit project.",
  "Đã chuyển khỏi phòng kinh doanh và đưa về kho.": "Transferred out of Sales and returned to inventory.",
  "Bàn giao MacBook Pro 14 M3 Pro cấp cho CEO làm việc.": "Assigned a MacBook Pro 14 M3 Pro to the CEO.",
  "Bàn giao Lenovo ThinkPad T14 Gen 4 cho Trưởng phòng Nhân sự.": "Assigned a Lenovo ThinkPad T14 Gen 4 to the HR Manager.",
  "Màn hình Dell UltraSharp bổ sung cho bàn Kế toán trưởng.": "Dell UltraSharp monitor added for the Chief Accountant desk.",
  "Màn hình đồ họa LG 27 inch cấp cho Designer thiết kế UI/UX.": "LG 27-inch graphics monitor issued to the UI/UX Designer.",
  "Điện thoại iPhone 15 Pro cấp cho Trưởng nhóm Kinh doanh liên hệ khách hàng.": "iPhone 15 Pro issued to the Sales Lead for customer contact.",
  "Xác nhận kiểm kê quý II/2026": "Confirm Q2/2026 inventory",
  "Nhân viên xác nhận tình trạng thực tế của laptop Dell Latitude 5440 (LT-001) trong đợt kiểm kê.": "Employee confirms the actual condition of Dell Latitude 5440 (LT-001) during the inventory session.",
  "Cập nhật tình trạng laptop LT-001": "Update laptop LT-001 condition",
  "Kiểm tra định kỳ tình trạng hoạt động của laptop Dell Latitude 5440.": "Periodic condition check for Dell Latitude 5440.",
  "Quạt tản nhiệt phát tiếng ồn lớn khi chạy tác vụ nặng.": "The cooling fan makes loud noise when running heavy tasks.",
  "Yêu cầu kiểm tra trong tuần.": "Inspection requested this week.",
  "Máy in thường xuyên kẹt giấy và xuất hiện vệt mực.": "The printer frequently jams and leaves ink streaks.",
  "Đã chuyển cho đơn vị bảo hành kiểm tra.": "Sent to the warranty provider for inspection.",
  "Pin sụt nhanh và cần vệ sinh thiết bị.": "Battery drains quickly and the device needs cleaning.",
  "Đã thay pin và vệ sinh hoàn tất.": "Battery replaced and cleaning completed.",
  "Cấu hình cổng VPN và thiết lập các quy tắc bảo mật mạng (Firewall rules) cho văn phòng làm việc mới.": "Configured VPN gateway and firewall rules for the new office.",
  "Phê duyệt bởi CTO.": "Approved by the CTO.",
  "Hệ thống RAID báo động một ổ đĩa SSD SAS 1.92TB bị hỏng cần thay thế dự phòng nóng.": "The RAID system reported a failed 1.92TB SAS SSD that needs hot-swap replacement.",
  "Bộ lưu điện UPS APC báo động lỗi ắc quy (Replace Battery). Cần mua cụm ắc quy dự phòng mới và thay thế gấp.": "The APC UPS reported a battery fault (Replace Battery). A replacement battery pack must be purchased and installed urgently.",
  "Đã gửi đề xuất mua sắm ắc quy chính hãng APC, đang chờ duyệt chi ngân sách từ phòng kế toán.": "Submitted a request to purchase an official APC battery pack, awaiting budget approval from Accounting.",
  "Màn hình MacBook Pro thỉnh thoảng có hiện tượng giật sọc ngang màu xanh ở cạnh dưới.": "The MacBook Pro screen occasionally shows blue horizontal flickering near the bottom edge.",
  "Cần kiểm tra xem do cáp màn hình hay lỗi card đồ họa.": "Needs inspection to determine whether the issue is the display cable or graphics card.",
  "Điện thoại bị rơi vỡ mặt kính màn hình trong quá trình đi công tác gặp gỡ khách hàng.": "The phone screen glass was broken during a customer visit.",
  "Máy in Canon thường xuyên bị kẹt giấy ở khay nạp và phát tiếng kêu lộc cộc.": "The Canon printer frequently jams at the paper tray and makes rattling noises.",
  "Tài liệu sau khi quét bằng khay nạp tự động ADF bị lệch góc khoảng 3-5 độ.": "Documents scanned through the ADF are skewed by about 3-5 degrees.",
  "Hỗ trợ căn chỉnh lại khay dẫn giấy hoặc cài đặt lại driver.": "Assist with realigning the paper feeder or reinstalling the driver.",
  "Sóng Wifi ở khu vực bàn thiết kế chập chờn, thường xuyên bị ngắt kết nối vào buổi chiều khi đông người dùng.": "Wi-Fi around the design desks is unstable and often disconnects in the afternoon when many users are online.",
  ...
  "Cần chia thêm VLAN khách (Guest WiFi VLAN 50) để cách ly truy cập với mạng nội bộ văn phòng.": "Need to add Guest WiFi VLAN 50 to isolate guest access from the internal office network.",
  "Đúng vị trí, hoạt động bình thường.": "Correct location, working normally.",
  "Đủ phụ kiện và không có hư hỏng.": "All accessories present and no damage.",
  "Một số phím không phản hồi.": "Some keys do not respond.",
  "Đã ghi nhận yêu cầu bảo trì.": "Maintenance request recorded.",
  "Đủ dây nguồn và điều khiển.": "Power cable and remote are present.",
  "Bạn có chắc chắn muốn hủy yêu cầu hỗ trợ này?": "Are you sure you want to cancel this support request?",
  "Hướng dẫn này có giải quyết được vấn đề?": "Did this guide resolve the issue?",
  ...
  "Vị trí tài sản": "Asset Location",
  "Làm thế nào để xác nhận tôi đã nhận tài sản?": "How do I confirm that I have received an asset?",
  "Khi Admin hoàn tất bàn giao, tài sản sẽ xuất hiện trong mục 'Tài sản của tôi'. Hãy kiểm tra mã tài sản, số serial và tình trạng thực tế trước khi xác nhận nhận tài sản.": "When an Admin completes the handover, the asset will appear in 'My Assets'. Check the asset code, serial number and actual condition before confirming receipt.",
  "Khi chuyển phòng ban, tài sản của tôi được xử lý như thế nào?": "What happens to my assets when I transfer departments?",
  "Admin sẽ căn cứ vào nhu cầu sử dụng để thu hồi hoặc chuyển tài sản sang phòng ban mới. Mọi thay đổi đều được lưu trong lịch sử bàn giao để bạn có thể tra cứu.": "An Admin will either reclaim the asset or transfer it to your new department based on usage needs. All changes are saved in the handover history for lookup.",
  "Tôi cần làm gì trước khi trả lại tài sản?": "What should I do before returning an asset?",
  "Hãy sao lưu dữ liệu công việc cần thiết, đăng xuất các tài khoản cá nhân và bàn giao đầy đủ phụ kiện đi kèm. Admin sẽ kiểm tra tình trạng tài sản trước khi xác nhận thu hồi.": "Back up any required work data, sign out of personal accounts and return all included accessories. An Admin will inspect the asset condition before confirming the return.",
  "Tôi theo dõi tiến độ sửa chữa tài sản ở đâu?": "Where can I track an asset repair request?",
  "Mở mục 'Yêu cầu hỗ trợ' để xem trạng thái yêu cầu. Các trạng thái chính gồm Chờ xử lý, Đang xử lý, Đã hoàn thành hoặc Từ chối.": "Open 'Support Requests' to view the request status. Main statuses include Pending, In Progress, Completed and Rejected.",
  "Tôi có nên tiếp tục sử dụng tài sản đang báo hỏng không?": "Should I keep using an asset that has been reported as broken?",
  "Không nên tiếp tục sử dụng nếu thiết bị có dấu hiệu mất an toàn, quá nhiệt, chập điện hoặc hư hỏng nghiêm trọng. Hãy ngắt nguồn nếu có thể và gửi yêu cầu hỗ trợ ngay.": "Do not continue using the device if it shows safety risks, overheating, electrical issues or severe damage. Power it off if possible and submit a support request immediately.",
  "Khi được yêu cầu kiểm kê tài sản, tôi cần làm gì?": "What should I do when asked to inventory my assets?",
  "Kiểm tra tài sản đang giữ, đối chiếu mã tài sản và số serial, sau đó xác nhận tình trạng thực tế theo hướng dẫn của Admin. Nếu có sai lệch, hãy ghi chú rõ trong phiên kiểm kê.": "Check the assets you hold, verify asset codes and serial numbers, then confirm the actual condition following the Admin's instructions. If anything differs, note it clearly in the inventory session.",
  "Nếu tài sản thực tế không khớp với hệ thống thì xử lý thế nào?": "What should I do if the physical asset does not match the system record?",
  "Không tự ý sửa thông tin. Hãy báo cho Admin trong phiên kiểm kê, cung cấp mã tài sản, vị trí hiện tại và mô tả sai lệch để được xác minh.": "Do not edit the information yourself. Report it to an Admin during the inventory session with the asset code, current location and a description of the mismatch for verification.",
  "Admin có thể nhập nhiều tài sản hoặc nhân viên cùng lúc không?": "Can Admins import many assets or employees at once?",
  "Có. Admin có thể sử dụng chức năng Nhập Excel tại trang quản lý tương ứng, tải file mẫu, điền dữ liệu đúng cột rồi xem trước kết quả trước khi xác nhận nhập.": "Yes. Admins can use the Excel Import feature on the relevant management page, download the template, fill the correct columns and preview results before confirming the import.",
  "Tại sao một số dòng trong file Excel không được nhập?": "Why are some rows in the Excel file not imported?",
  "Các dòng thiếu trường bắt buộc, sai định dạng, trùng mã hoặc tham chiếu tới phòng ban và danh mục không tồn tại sẽ bị đánh dấu lỗi. Hãy sửa theo thông báo ở bước xem trước rồi tải lại file.": "Rows with missing required fields, invalid formats, duplicate codes or references to missing departments/categories are marked as errors. Fix them according to the preview messages and upload the file again.",
  "Làm thế nào để tìm vị trí một tài sản trong văn phòng?": "How do I find an asset's location in the office?",
  "Admin có thể mở mục 'Sơ đồ mặt bằng', chọn tầng hoặc khu vực và tìm tài sản theo mã hoặc tên. Vị trí hiển thị dựa trên dữ liệu được cập nhật gần nhất.": "Admins can open 'Floor Plans', choose a floor or area, and search assets by code or name. The displayed location is based on the latest updated data.",
  "Vì sao tài sản chưa xuất hiện trên sơ đồ mặt bằng?": "Why does an asset not appear on the floor plan yet?",
  "Tài sản chỉ xuất hiện khi đã được gán vị trí và tọa độ trên sơ đồ. Hãy kiểm tra thông tin vị trí của tài sản hoặc liên hệ Admin để cập nhật.": "Assets only appear after they have been assigned a location and coordinates on the floor plan. Check the asset's location details or contact an Admin to update them.",
  "Tôi có thể đính kèm loại tệp nào khi gửi góp ý?": "What file types can I attach when submitting feedback?",
  "Bạn có thể đính kèm tài liệu hoặc hình ảnh minh họa có dung lượng tối đa 10 MB. Không nên tải lên tệp chứa mật khẩu, khóa truy cập hoặc dữ liệu nhạy cảm.": "You can attach supporting documents or images up to 10 MB. Avoid uploading files that contain passwords, access keys or sensitive data.",
  "Bạn vào mục 'Tài sản của tôi' trong thanh điều hướng bên trái. Tất cả tài sản đang được bàn giao sẽ hiển thị tại đây.": "Go to 'My Assets' in the left sidebar. All assets currently assigned to you will be displayed there.",
  "Vào mục 'Yêu cầu hỗ trợ' → Tạo yêu cầu mới, chọn loại 'Bảo trì/Sự cố', mô tả tình trạng và đính kèm ảnh nếu có. Admin sẽ xem xét và phản hồi.": "Go to 'Support Requests' -> create a new request, select 'Maintenance/Incident', describe the issue and attach a photo if available. An Admin will review and respond.",
  "Hệ thống có 6 trạng thái: Sẵn sàng (AVAILABLE), Đã bàn giao (ASSIGNED), Đang bảo trì (MAINTENANCE), Hỏng hóc (BROKEN), Thất lạc (LOST) và Thanh lý (DISPOSED).": "The system has 6 statuses: Available (AVAILABLE), Assigned (ASSIGNED), In Maintenance (MAINTENANCE), Broken (BROKEN), Lost (LOST) and Disposed (DISPOSED).",
  "Báo cáo có thể lọc theo: khoảng thời gian, trạng thái tài sản, danh mục, phòng ban sở hữu, phòng ban sử dụng và vị trí. Bộ lọc được áp dụng cho cả khi xuất file.": "Reports can be filtered by date range, asset status, category, owning department, using department and location. Filters also apply when exporting files.",
  "Vào mục 'Đổi mật khẩu' trong thanh điều hướng bên trái. Nhập mật khẩu hiện tại, mật khẩu mới và xác nhận mật khẩu mới. Mật khẩu mới phải đủ mạnh.": "Go to 'Change Password' in the left sidebar. Enter your current password, new password and confirmation. The new password must be strong enough.",
  "Vào 'Cài đặt' → tab 'Bảo mật' hoặc chuyên mục 'Lịch sử đăng nhập'. Bạn sẽ thấy thời gian đăng nhập, thiết bị, trình duyệt và địa chỉ IP của từng phiên.": "Go to 'Settings' -> 'Security' tab or the 'Login History' section. You will see the login time, device, browser and IP address for each session.",
  "Vào mục 'Góp ý & Phản hồi' trong thanh điều hướng hoặc Cài đặt. Điền tiêu đề, nội dung, loại góp ý và mức độ ưu tiên. Bạn cũng có thể đính kèm file minh họa.": "Go to 'Feedback & Suggestions' in the sidebar or Settings. Fill in the title, content, feedback type and priority. You can also attach a supporting file.",
  "Có, Admin sẽ xem xét và cập nhật trạng thái góp ý của bạn. Bạn có thể theo dõi trạng thái (Chờ xử lý → Đang xử lý → Đã xử lý) trong lịch sử góp ý của mình.": "Yes, an Admin will review and update the status of your feedback. You can track the status (Pending -> In Progress -> Resolved) in your feedback history.",
  "Bạn có thể gửi yêu cầu hỗ trợ qua mục 'Yêu cầu hỗ trợ' hoặc 'Góp ý & Phản hồi'. Với các vấn đề khẩn cấp, hãy liên hệ trực tiếp phòng IT.": "You can submit support requests via 'Support Requests' or 'Feedback & Suggestions'. For urgent issues, contact the IT department directly.",
  ...
  "Tài liệu đã đính kèm": "Attached Documents",
  ...
  "Họ tên người liên hệ": "Contact Person Full Name",
