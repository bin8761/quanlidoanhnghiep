...
const departmentsValidators = Object.freeze({
  ...
  create: Object.freeze({
    body: z.object({
      name: trimmedRequiredString("Department name").max(100, "Department name must not exceed 100 characters"),
  ...
  update: Object.freeze({
    params: idParamSchema,
    body: z.object({
      name: trimmedRequiredString("Department name").max(100, "Department name must not exceed 100 characters").optional(),
      description: z.string().trim().max(500, "Description must not exceed 500 characters").optional().nullable(),
    }),
  }),
